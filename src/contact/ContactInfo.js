    ...
    render() {
        return (
            <React.Fragment>
                ...
                <a className="contact_link" rel="noopener noreferrer" href="mailto:contact@rileymathews.com"><Icon isSize="medium" className="fas fa-envelope fa-2x contact_icon"  /></a>
            </React.Fragment>
        )
    }
}
